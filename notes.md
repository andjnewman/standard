...
how to address digital exclusion?

Contact Alexander Red Cross on emergency and crisis response use case. What data is useful for analysis. Need to know who participated in specific activities and possibly reocurring issues (area prone to flooding) we need someone with some experience to hit the ground running and also new people to keep the response team pool resilient.

Contact Calum SCVO on taxonomies, standardisation, Milo's central volunteering data approach, VMSs relationship to SCVO, the gathering event 11/12th of February, go as a delegate. registry of organisations?


model

roles and skills (emergency response)

events (new year, christmas, big help out, covid)

registry of organisations must be flexible, some charities, other are for profit companies... some small... some spontaneous...



# Balance cost of compute and accuracy of results with structured data

## Add and gather user stories to the repo

## Natural language integration

Spontaneous volunteering (no application/capacity to manage the crisis on side of organisations) vs application

response coordination is cross-organisations

collaborative, open situation report with latest updates.
